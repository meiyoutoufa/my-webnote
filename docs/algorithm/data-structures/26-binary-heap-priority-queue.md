...
前文[二叉堆的原理](25-二叉堆核心原理及可视化.md) 介绍了二叉堆的基本性质、API 和常见应用。
...
**难点分析**
在前文[二叉堆的原理](25-二叉堆核心原理及可视化.md)中你应该也感觉到了，二叉堆的难点在于 你**在插入或删除元素时，还要保持堆的性质**。
...
我在[二叉树基础](18-二叉树基础及常见类型.md)中介绍过完全二叉树，就是除了最后一层，其他层的节点都是满的，最后一层的节点都靠左排列。
