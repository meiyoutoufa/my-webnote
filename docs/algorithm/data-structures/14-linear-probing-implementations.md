...
前文
[哈希表核心原理](11-hashtable-core-principles.md) 中我介绍了哈希表的核心原理和几个关键概念，
[拉链法原理和实现](12-hashtable-chaining-implementation.md) 中介绍了拉链法的实现，
[线性探查法的两个难点](./13-linear-probing-challenges.md) 介绍了线性探查法实现哈希表的难点所在，并给出了两种方法解决删除元素时的空洞问题，本文会同时给出这两种方法的参考代码实现。
